		...
		foreach($row as $value) {
			...
			<tbody>
				<tr>
					...
					<form method = "post" action= "Home_Controller.html_product_editrequest_<?php  echo $productId;?>">
						<td><button class="btn btn-primary" name = "editThis" > Edit </button></td>
					</form>
					<form method = "post" action= "Home_Controller.html_product_delete_<?php  echo $productId;?>">
